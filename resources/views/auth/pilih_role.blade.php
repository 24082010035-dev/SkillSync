<!-- resources/views/pilih_role.blade.php -->
...
<body class="bg-blue-50 text-gray-800 min-h-screen">
    ...
    <div class="max-w-3xl mx-auto pt-16 pb-10 text-center relative">
        ...
        <div class="grid md:grid-cols-2 gap-6 px-10">
            ...
            <!-- MAHASISWA -->
            <div class="bg-white px-6 py-10 rounded-2xl shadow-md flex flex-col justify-between min-h-[500px]">
            ...
            <!-- MENTOR -->
            <div class="bg-white p-8 rounded-2xl shadow-md flex flex-col justify-between min-h-[500px]">
        ...
        <p class="mt-10 text-sm text-gray-600">
            Sudah punya akun?
            <a href="{{ route('login') }}"
                class="text-[#2C7DA0] hover:underline">
                Login di sini
            </a>
        </p>
